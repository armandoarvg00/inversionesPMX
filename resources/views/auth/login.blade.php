                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Ingresa con tu usuraio y contraseña.</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                          <!--  <input type="email" name="email" class="form-control form-control-lg" value="{{ old('email') ?? 'admin@argon.com' }}" aria-label="Email">-->
                                            <input type="email" name="email" class="form-control form-control-lg" value="" aria-label="Email" placeholder="Usuario">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://inversionpemx.com.mx/img/signin-ill2.jpg');
              background-size: cover; ">
<!--style="background-image: url('https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/signin-ill.jpg');-->
                                <span class="mask bg-gradient-success opacity-4"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Invierte de forma segura"</h4>
                                <p class="text-white position-relative">Con más de 100,000 usuarios registados y ganancias de 50% al mes.</p>
                            </div>
                        </div>
                    </div>
                </div>

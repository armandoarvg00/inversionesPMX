...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-40 pt-5 pb-11 m-3 border-radius-lg"
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                    ...
                                    @error('username') <p class='text-danger text-xs pt-1'> El usuario es requerido </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <input type="email" name="email" class="form-control" placeholder="Email" aria-label="Email" value="{{ old('email') }}" >
                                    @error('email') <p class='text-danger text-xs pt-1'> El email es requerido </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <input type="firstname" name="firstname" class="form-control" placeholder="Nombre" aria-label="firstname" value="{{ old('firstname') }}">
                                    @error('firstname') <p class='text-danger text-xs pt-1'> EL nombre es requerido </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <input type="lastname" name="lastname" class="form-control" placeholder="Apellido" aria-label="lastname" value="{{ old('lastname') }}">
                                    @error('lastname') <p class='text-danger text-xs pt-1'> El apellido es requerido </p> @enderror
                                </div>
                                    
                                <div class="flex flex-col mb-3">
                                    <input type="password" name="password" class="form-control" placeholder="Password" aria-label="Password">
                                    @error('password') <p class='text-danger text-xs pt-1'> La contraseña es requerida </p> @enderror
                                </div>
                                <input type="hidden" name="postal" class="form-control" value="0">
                                    <input type="hidden" name="about" class="form-control" value="0">
                                <div class="form-check form-check-info text-start">
                                    ...
                                    @error('terms') <p class='text-danger text-xs'> Debes aceptar los terminos </p> @enderror
                                </div>
